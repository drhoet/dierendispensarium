...
/* TODO: retain active slide */
    ...
    _goto: function($slides_container, index_or_direction, callback) {
      ...
      if ($slides_container.css(self._margin_position_property) === new_margin_left) {
        ...
        $slides_container.trigger('orbit:after-slide-change', [{slide_number: active_index-self._buffer_size+1, total_slides: $slides_container.children().length - 2 * self._buffer_size}]);
        callback();
      } else {
        var properties = {};
